class CaDTO {
  ...
  @override
  String toString() {
    return 'CaDTO{id: $_id, nome: $_nome, username: $_username, password: $_password, email: $_email, num_telefono: $_num_telefono, sito_web: $_sito_web, via: $_via, citta: $_citta, provincia: $_provincia}';
  }
}
