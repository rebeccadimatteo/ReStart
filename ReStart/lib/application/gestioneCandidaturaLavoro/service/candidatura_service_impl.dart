...
class CandidaturaServiceImpl implements CandidaturaService{
  ...
  Future<bool> candidatura(int? idUtente, int? idLavoro) async {
    if(_annuncioDiLavoroDAO.existById(idLavoro!) == false || _utenteDAO.existById(idUtente!) == false) {
      return false;
    }
    ...
    CandidaturaDTO candidaturaDTO = CandidaturaDTO(id_lavoro: idLavoro, id_utente: idUtente);
