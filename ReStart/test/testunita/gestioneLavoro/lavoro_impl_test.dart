...
void main() {
  ...
  group('Test Aggiunta Lavoro', () {
    test('Aggiunta del lavoro non va a buon fine, lunghezza nome errata', () async {

      dynamic result = false;
      AnnuncioDiLavoroDTO annuncio = AnnuncioDiLavoroDTO(
          id_ca: 1,
          nomeLavoro: 'Opportunità di carriera: Sviluppatore Software Senior per Progetti Innovativi in Tecnologie Avanzate ',
          descrizione: 'Sviluppatore Software Senior per progetti innovativi. Esperienza nella progettazione e sviluppo software. Capacità di leadership e collaborazione. Ambiente stimolante, pacchetto retributivo competitivo.',
          approvato: true,
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta lunghezza nome offerta errata: TEST SUPERATO 3.1_1');
      }
    });

    test('Aggiunta Lavoro non va a buon fine perchè la lunghezza della descriione è errata', () async {
      dynamic result = false;
      AnnuncioDiLavoroDTO annuncio = AnnuncioDiLavoroDTO(
          id_ca: 1,
          nomeLavoro: 'Senior Software Developer per Progetti Innovativi in Tecnologie Avanzate ',
          descrizione: 'Sviluppatore Software Senior con comprovata esperienza nella progettazione e sviluppo software per progetti innovativi. Dimostrate capacità di leadership, collaborazione e risoluzione dei problemi. Offriamo un ambiente stimolante con un pacchetto retributivo competitivo, promuovendo la crescita professionale attraverso formazione continua e progetti sfidanti.',
          approvato: true,
          via: 'Via delle Acacie 56',
          citta: 'Roma',
          provincia: 'RM',
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta lunghezza descrizione errata: TEST SUPERATO 3.1_2');
      }
    });

    test('Aggiunta Lavoro non va a buon fine perchè formato immagine errato', () async {
      dynamic result = false;
      AnnuncioDiLavoroDTO annuncio = AnnuncioDiLavoroDTO(
          id_ca: 1,
          nomeLavoro: 'Senior Software Developer per Progetti Innovativi in Tecnologie Avanzate ',
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta formato immagine errato: TEST SUPERATO 3.1_3');
      }
    });
    ...
    test('Aggiunta Lavoro non va a buon fine formato email errato', () async {
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta formato email errato: TEST SUPERATO 3.1_4');
      }
    });

    test('Aggiunta Lavoro non va a buon fine formato telefono errato', () async {
      dynamic result = false;
      AnnuncioDiLavoroDTO annuncio = AnnuncioDiLavoroDTO(
          id_ca: 1,
          nomeLavoro: 'Senior Software Developer per Progetti Innovativi in Tecnologie Avanzate ',
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta formato telefono errato: TEST SUPERATO 3.1_5');
      }
    });
    ...
    test('Aggiunta Lavoro non va a buon fine formato via errato', () async {
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta formato via errato: TEST SUPERATO 3.1_6');
      }
    });
    ...
    test('Aggiunta Lavoro non va a buon fine formato citta errato', () async {
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta formato citta errato: TEST SUPERATO 3.1_7');
      }
    });

    test('Aggiunta Lavoro non va a buon fine formato provincia errato', () async {
      dynamic result = false;
      AnnuncioDiLavoroDTO annuncio = AnnuncioDiLavoroDTO(
          id_ca: 1,
          nomeLavoro: 'Senior Software Developer per Progetti Innovativi in Tecnologie Avanzate ',
      ...
      if (validaN &&
        ...
        expect(result, false);
        print('Aggiunta lavoro non avvenuta formato provincia errato: TEST SUPERATO 3.1_8');
      }
    });
